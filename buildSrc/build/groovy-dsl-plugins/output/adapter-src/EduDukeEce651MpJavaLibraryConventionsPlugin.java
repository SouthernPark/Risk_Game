...
/**
 * Precompiled edu.duke.ece651.mp.java-library-conventions script plugin.
 **/
public class EduDukeEce651MpJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduDukeEce651MpJavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduDukeEce651MpJavaLibraryConventions").asSubclass(BasicScript.class);
