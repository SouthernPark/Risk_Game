...
/**
 * Precompiled edu.duke.ece651.mp.java-application-conventions script plugin.
 **/
public class EduDukeEce651MpJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduDukeEce651MpJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("edu.duke.ece651.mp.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduDukeEce651MpJavaApplicationConventions").asSubclass(BasicScript.class);
